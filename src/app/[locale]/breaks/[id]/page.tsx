  ...
  const [{ data: schoolData }, { data: matchedCamps }, { data: coverageRows }] =
    await Promise.all([
      ...
      svc
        .from('camps')
        .select(
          'id, slug, name, tagline, description, ages_min, ages_max, price_tier, categories, neighborhood, verified, is_featured, phone, address, website_url, hours_start, hours_end, price_min_cents, price_max_cents, registration_url, registration_deadline, logo_url, hero_url',
        )
        .eq('verified', true)
